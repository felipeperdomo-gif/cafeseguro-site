    ...
    <div style={{ backgroundColor: '#FFFFFF', minHeight: '100vh', color: '#002D72', fontFamily: 'sans-serif' }}>
          ...
          <div>
            {session ? (
              <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                ...
                <button onClick={() => signOut()} style={{ backgroundColor: 'transparent', color: '#002D72', border: '1px solid #002D72', padding: '6px 16px', borderRadius: '20px', cursor: 'pointer', fontWeight: '600', fontSize: '13px' }}>
                  Salir
                </button>
              </div>
            ) : (
              <button onClick={() => signIn("google")} style={{ display: 'flex', alignItems: 'center', gap: '8px', backgroundColor: '#FFFFFF', border: '1px solid #002D72', padding: '6px 16px', borderRadius: '20px', fontWeight: '700', color: '#002D72', cursor: 'pointer', fontSize: '13px' }}>
      ...
      <main style={{ paddingTop: '160px', textAlign: 'center', paddingLeft: '20px', paddingRight: '20px' }}>
        <div style={{ maxWidth: '850px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontSize: 'clamp(38px, 6vw, 68px)', fontWeight: '900', margin: '20px 0', lineHeight: '1.1', color: '#002D72', letterSpacing: '-0.02em' }}>
            Nimbus presenta:<br />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(290px, 1fr))', gap: '30px', maxWidth: '1100px', margin: '90px auto' }}>
          {[
            ...
            <div key={item.ciudad} style={{ backgroundColor: '#FFFFFF', padding: '40px 30px', borderRadius: '24px', border: '1px solid #EAF0F6', textAlign: 'left', boxShadow: '0 10px 30px rgba(0,45,114,0.04)' }}>
              <p style={{ color: '#25D366', fontWeight: '700', fontSize: '13px', marginBottom: '8px', letterSpacing: '0.5px' }}>{item.fecha}</p>
              <h3 style={{ fontSize: '34px', fontWeight: '800', color: '#002D72', marginBottom: '12px' }}>{item.ciudad}</h3>
              <p style={{ color: '#666666', fontSize: '14px', marginBottom: '30px', lineHeight: '1.4' }}>Networking y análisis profundo sobre la transformación del sector.</p>
              <button style={{ width: '100%', backgroundColor: '#002D72', color: '#FFFFFF', border: 'none', padding: '14px', borderRadius: '12px', fontWeight: '700', fontSize: '15px', cursor: 'pointer' }}>
                Inscribirme →
              </button>
            </div>
          ))}
      ...
      {/* FOOTER INSTITUCIONAL COMPLETO (ESTILO SSN) */}
      <footer style={{ backgroundColor: '#FFFFFF', borderTop: '1px solid #EDE4D8', padding: '60px 40px 40px', marginTop: '100px', color: '#707070', fontSize: '12px', textAlign: 'left' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          
          {/* Fila 1: Redes y Contacto */}
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '100px', marginBottom: '40px' }}>
            <div>
              <p style={{ fontWeight: 'bold', marginBottom: '15px', color: '#333333' }}>Seguinos:</p>
            ...
            <div>
              <p style={{ fontWeight: 'bold', marginBottom: '15px', color: '#333333' }}>Contactanos</p>
              <div style={{ display: 'flex', gap: '12px' }}>
                <span style={{ display: 'flex', width: '32px', height: '32px', backgroundColor: '#0051FF', borderRadius: '50%', justifyContent: 'center', alignItems: 'center', color: '#fff' }}>📞</span>
                <span style={{ display: 'flex', width: '32px', height: '32px', backgroundColor: '#00A3AD', borderRadius: '50%', justifyContent: 'center', alignItems: 'center', color: '#fff' }}>✉️</span>
              </div>
            </div>
          </div>

          {/* Fila 2: Datos Técnicos SSN */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', borderTop: '1px solid #EAF0F6', paddingTop: '30px', paddingBottom: '30px', alignItems: 'center' }}>
            <div>
              <p style={{ margin: 0, color: '#888888' }}>Nº de inscripción SSN</p>
              <p style={{ margin: 0, fontWeight: 'bold', color: '#555555' }}>1647</p>
            </div>
            <div>
              <p style={{ margin: 0, color: '#888888', maxWidth: '200px' }}>Departamento de Orientación y Asistencia al Asegurado</p>
            </div>
            <div>
          ...
          {/* Fila 3: Textos legales de Responsabilidad */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '40px', borderTop: '1px solid #EAF0F6', paddingTop: '30px' }}>
            ...
            <div style={{ fontSize: '11px', lineHeight: '1.8' }}>
              ...
              <p style={{ margin: 0 }}>Teléfono: +54 9 3442 46-1715</p>
            </div>
          </div>
